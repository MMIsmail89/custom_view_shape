...
public class Shape_custom_view2 extends View {
    ...
    public Shape_custom_view2(Context context) {
        super(context);
        init(null);
    }

    public Shape_custom_view2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public Shape_custom_view2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public Shape_custom_view2(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
